...
<!--      <div class="container">-->
<!--        <h1><a href="#/committee">Committee</a></h1>-->
<!--        <span><a href="#/">Home</a></span><span><i class="fa fa-angle-right"></i>Committee</span>-->
<!--      </div>-->
<!--    </section>-->
    <section class="meet-team section">
      <div class="container">
        <div class="title sec-title">
          ...
          <p class="p">Yu-Ping Wang，邓飞艳，Hao Zhu，刘鹏渊，李明，李轩，</p>
          <p class="p">李淼新，沈洁，吴焕梅，肖红梅，肖苏妹，杨铁林，张峰，张垒，</p>
          <p class="p">张丽姝，官方霖，郑厚峰，郭燕，徐书华，蒋慧，蒋德科，</p>
          <p class="p">景乃禾，雷署丰，Wei Lei</p>
          <br><br>
          <h3>组织委员会</h3>
          <p class="p">主席：杨铁林</p>
          <br>
