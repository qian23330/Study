...
import com.bigc.shortlink.admin.dto.req.ShortLinkGroupSaveReqDTO;
...
public class GroupController {
    ...
    public Result<Void> updateGroup(@RequestBody ShortLinkGroupUpdateReqDTO requetParam) {
        groupService.updateGroup(requetParam);
        return Results.success();
    }
